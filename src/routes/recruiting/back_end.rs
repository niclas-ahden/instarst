...
pub fn BackEndDeveloper(cx: Scope) -> impl IntoView {
    view! { cx,
        <section class="JobDescription">
            <h2>
                "Back-end utvecklare — TypeScript"
            </h2>
            ...
            <ul>
                ...
                <li>"Gedigen erfarenhet av att utveckla snabba, vältestade och skalbara webbapplikationer"</li>
                <li>"Koll på relationsdatabaser (design, optimera queries, passande index etc.)"</li>
            ...
            <ul>
                <li>"Djupare kunskap inom Linux och servrar (ex. någon kluster-teknik, serverhantering, infrastructure as code)"</li>
                <li>"Grafisk design (om du arbetat mycket med ett grafiskt program så förstår du stora delar av vad vår applikation måste stödja för att designa en skylt)"</li>
                <li>"Full-stack eller intresse utöver back-end (vill du arbeta full-stack eller utvecklas inom front-end så finns den möjligheten här)"</li>
            </ul>
            ...
            // TODO: Add form when form-handling has been implemented
